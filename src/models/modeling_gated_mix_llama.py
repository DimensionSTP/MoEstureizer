...
class GatedMixLlamaForCausalLM(LlamaForCausalLM, GenerationMixin):
    def __init__(
        self,
        ...
        self.lm_router = LMHeadGatedRouter(configs=configs)
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        output_router_logits = (
            ...
            else self.configs[0].output_router_logits
        )
        return_dict = (
        ...
        if output_router_logits:
            logits, aux_loss, router_logits = router_output
        else:
            logits, aux_loss = router_output
            router_logits = None
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            router_aux_loss_coef (float, optional): Coefficient for the auxiliary load balancing loss.
        ...
        if initialize:
            ...
            saved_coef = config.get(
                "router_aux_loss_coef",
                router_aux_loss_coef,
            )
            model = cls(
                configs=configs,
                router_aux_loss_coef=saved_coef,
            )
